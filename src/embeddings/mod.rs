...
impl EmbeddingGenerator {
    ...
    pub async fn generate(&self, text: &str) -> Result<Vec<f32>> {
        ...
        let is_meaning_life = (text_lower.contains("meaning") || text_lower.contains("purpose")) && 
                             (text_lower.contains("life") || text_lower.contains("existence") || text_lower.contains("human"));
        
        // Common question words that should have LOW weight
        let common_words = vec![
            "is", "the", "does", "tell", "me", "about",
            "can", "you", "please", "give", "show",
            "a", "an", "of", "to", "what",
            "for", "with", "from", "in", "on", "at", "by", "and", "or", "but"
        ];
        
        // Extract key terms (non-common words) and normalize contractions
        let key_terms: Vec<String> = words.iter()
            .map(|w| {
        ...
        let semantic_categories = vec![
            ("javascript", vec!["javascript", "js", "node", "npm", "react", "vue", "typescript", "jquery", "angular", "webpack"]),
            ("python", vec!["python", "pip", "django", "flask", "pandas", "numpy", "pytest", "anaconda", "jupyter"]),
            ("machine_learning", vec!["machine", "learning", "ml", "ai", "artificial", "intelligence", "neural", "deep", "model", "algorithm", "training", "dataset"]),
            ("kubernetes", vec!["kubernetes", "k8s", "kubectl", "pod", "deployment", "service", "ingress", "helm", "cluster"]),
            ("docker", vec!["docker", "container", "dockerfile", "image", "compose", "registry", "volume", "swarm"]),
            ("blockchain", vec!["blockchain", "crypto", "bitcoin", "ethereum", "defi", "smart", "contract", "ledger", "mining"]),
            ("life_philosophy", vec!["life", "meaning", "purpose", "existence", "philosophy", "human", "death", "living", "soul", "consciousness", "what's", "whats", "significance"]),
            ("food", vec!["food", "cook", "pasta", "eat", "recipe", "kitchen", "meal", "dish", "ingredient", "cuisine"]),
            ("physics_light", vec!["light", "speed", "photon", "electromagnetic", "wave", "optics", "laser", "radiation"]),
            ("physics_sound", vec!["sound", "acoustic", "wave", "frequency", "vibration", "audio", "noise", "decibel"]),
            ("physics_relativity", vec!["relativity", "einstein", "spacetime", "gravity", "quantum", "physics", "theory"]),
            ("fibonacci", vec!["fibonacci", "sequence", "recursion", "recursive", "series", "golden", "ratio"]),
            ("function", vec!["function", "method", "procedure", "algorithm", "calculate", "compute", "return"]),
        ];
