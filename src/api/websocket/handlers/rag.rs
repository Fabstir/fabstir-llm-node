...
use crate::api::websocket::session::WebSocketSession;
...
///
/// Searches the session's vector store and returns top-k results
/// with similarity scores and timing information.
