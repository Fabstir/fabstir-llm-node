...
impl ResponseTimeWindow {
    ...
    fn percentile(&self, p: f64) -> f64 {
        ...
        let mut sorted: Vec<u128> = self.times.iter().map(|(_, d)| d.as_millis()).collect();
        sorted.sort();
...
impl PrometheusMetrics {
    ...
    pub async fn record_message_with_labels(
        &self,
        session_id: &str,
        _msg_type: &str,
        _labels: &[(&str, &str)],
    ...
    pub async fn record_error_with_labels(
        &self,
        session_id: &str,
        _error: &str,
        _labels: &[(&str, &str)],
                ...
                axum::routing::get(move || {
                    ...
                    async move {
                        ...
                        format!(
                            ...
                            snapshot.total_sessions_created, snapshot.avg_inference_time_ms
                        )
                    }
                }),
            );
