...
AUDIT_F4_JOB_MARKETPLACE="0xD067719Ee4c514B5735d1aC0FfB46FECf2A9adA4"
...
DEPRECATED_JOB_MARKETPLACE_2="0x95132177F964FF053C1E874b53CF74d819618E06"
...
if [ "$CONTRACT_JOB_MARKETPLACE" = "$DEPRECATED_JOB_MARKETPLACE" ] || [ "$CONTRACT_JOB_MARKETPLACE" = "$DEPRECATED_JOB_MARKETPLACE_2" ]; then
