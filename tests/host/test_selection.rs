...
fn create_mock_hosts_with_metrics() -> (Vec<HostInfo>, HashMap<Address, PerformanceMetrics>) {
    ...
    metrics.insert(addr1, PerformanceMetrics {
        jobs_completed: 1000,
        success_rate: 0.99,
    ...
    metrics.insert(addr2, PerformanceMetrics {
        jobs_completed: 500,
        success_rate: 0.95,
    ...
    metrics.insert(addr3, PerformanceMetrics {
        jobs_completed: 200,
        success_rate: 0.90,
    ...
    metrics.insert(addr4, PerformanceMetrics {
        jobs_completed: 800,
        success_rate: 0.96,
...
async fn test_top_n_hosts_ranking() {
    ...
    assert!(top_3.contains(&"0x2222222222222222222222222222222222222222".parse::<Address>().unwrap()));
}
...
async fn test_cost_optimization_selection() {
    ...
    assert_eq!(cheapest.unwrap(), "0x3333333333333333333333333333333333333333".parse::<Address>().unwrap());
}
...
async fn test_performance_selection() {
    ...
    assert_eq!(fastest.unwrap(), "0x1111111111111111111111111111111111111111".parse::<Address>().unwrap());
}
...
async fn test_load_balancing_selection() {
    ...
    assert_eq!(least_loaded.unwrap(), "0x3333333333333333333333333333333333333333".parse::<Address>().unwrap());
}
...
async fn test_filtering_by_requirements() {
    ...
    assert_eq!(result.unwrap(), "0x1111111111111111111111111111111111111111".parse::<Address>().unwrap());
}
...
async fn test_custom_scoring_weights() {
    ...
    assert_eq!(best.unwrap(), "0x3333333333333333333333333333333333333333".parse::<Address>().unwrap());
}
