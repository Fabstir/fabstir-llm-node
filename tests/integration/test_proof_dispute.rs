...
async fn test_dispute_output_tampering_attack() -> Result<()> {
    ...
    result_store.write().await.store_result(1000, tampered_result).await?;
...
async fn test_dispute_proof_reuse_attack() -> Result<()> {
    ...
    result_store.write().await.store_result(2000, result_2000).await?;
    proof_store.write().await.store_proof(2000, proof_2000.clone()).await?;
    ...
    result_store.write().await.store_result(2001, result_2001).await?;
    proof_store.write().await.store_proof(2001, proof_2000).await?; // Reused proof!
...
async fn test_dispute_cross_job_output_theft() -> Result<()> {
    ...
    result_store.write().await.store_result(3000, result_a.clone()).await?;
    proof_store.write().await.store_proof(3000, proof_a.clone()).await?;
    ...
    result_store.write().await.store_result(3001, result_b).await?;
...
async fn test_dispute_token_inflation_attack() -> Result<()> {
    ...
    result_store.write().await.store_result(4000, inflated_result).await?;
...
async fn test_dispute_input_hash_tampering() -> Result<()> {
    ...
    result_store.write().await.store_result(5000, tampered_input).await?;
...
async fn test_dispute_model_substitution_attack() -> Result<()> {
    ...
    result_store.write().await.store_result(6000, different_model_result).await?;
    ...
    assert!(is_valid, "Model label is metadata, not cryptographically verified");
...
async fn test_dispute_parallel_fraud_attempts() -> Result<()> {
    ...
    for job_id in 7000..7005 {
        ...
        result_store.write().await.store_result(job_id, tampered).await?;
    }
