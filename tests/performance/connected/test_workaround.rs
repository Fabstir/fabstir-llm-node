...
async fn test_with_connection_reset() {
    ...
    while total_inserted < target {
        ...
        println!("\n[Batch {}] Creating new connection...", total_inserted / batch_size);
        ...
        println!("  Batch completed: {} vectors in {:?}", batch_count, batch_duration);
    ...
    println!("\n=== RESULTS ===");
    println!("Successfully inserted {} vectors with connection resets", total_inserted);
